...
use crate::{
    VirtAddr,
    structures::paging::{PageTableIndex, PageTableLevel},
};

/// Trait for abstracting over the three possible page sizes on LoongArch64 with required restrictions, 4KiB, 2MiB, 1GiB.
